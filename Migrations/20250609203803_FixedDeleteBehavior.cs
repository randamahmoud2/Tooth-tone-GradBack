        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dispense = table.Column<int>(type: "int", nullable: true),
                    Refill = table.Column<int>(type: "int", nullable: true),
                    Expiration = table.Column<int>(type: "int", nullable: true),
                    PatientInstruct = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerioCharts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PerioCharts_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                         onDelete: ReferentialAction.NoAction); 
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AllowSubstitution = table.Column<bool>(type: "bit", nullable: false),
                    PharmacyInstructions = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "PerioMeasurements",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PerioChartId = table.Column<int>(type: "int", nullable: false),
                    ToothNumber = table.Column<int>(type: "int", nullable: false),
                    GingivalMargin = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PocketDepth = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BleedingOnProbing = table.Column<bool>(type: "bit", nullable: false),
                    PlaqueIndex = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerioMeasurements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PerioMeasurements_PerioCharts_PerioChartId",
                        column: x => x.PerioChartId,
                        principalTable: "PerioCharts",
                        principalColumn: "Id",
                         onDelete: ReferentialAction.NoAction); 
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Strength = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Dispense = table.Column<int>(type: "int", nullable: false),
                    Refill = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerioCharts_PatientId",
                table: "PerioCharts",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PerioMeasurements_PerioChartId",
                table: "PerioMeasurements",
                column: "PerioChartId");
